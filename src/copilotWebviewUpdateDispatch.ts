...
import { createUpdateCockpitBoardMessage } from "./copilotWebviewCockpitBridge";
import {
...
import { postSchedulerCatalogMessages } from "./copilotWebviewState";
import type {
  CockpitBoard,
