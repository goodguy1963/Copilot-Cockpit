...
function readSchedulerWebviewScriptSource(): string {
  ...
  return readSourceFilesFromDirectory(
    ["../../../media"],
    (fileName) => fileName.endsWith(".js") && fileName !== "cockpitWebview.entry.js",
  );
}

function readGeneratedSchedulerWebviewScriptSource(): string {
  return readWorkspaceFile("../../../media/generated/cockpitWebview.js");
}

function readSchedulerWebviewTemplateSource(): string {
  // Template/CSS markup is composed from cockpitWebview* source modules.
  return readSourceFilesFromDirectory(
    ["../../../src"],
    (fileName) => fileName.startsWith("cockpitWebview") && fileName.endsWith(".ts"),
  );
}

function readSchedulerWebviewStringsSource(): string {
  return readWorkspaceFile("../../../src/cockpitWebviewStrings.ts");
}

function readSchedulerWebviewDebugSource(): string {
  return readWorkspaceFile("../../../media/cockpitWebviewDebug.js");
}
