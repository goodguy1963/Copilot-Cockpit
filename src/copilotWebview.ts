...
import {
  ...
  escapeHtmlAttr,
  serializeForWebview,
} from "./copilotWebviewContentUtils";
...
} from "./copilotWebviewMessageFactory";
import { handleSettingsWebviewMessage } from "./copilotWebviewSettingsHandler";
import { handleTaskWebviewMessage } from "./copilotWebviewTaskHandler";
import { handleJobWebviewMessage } from "./copilotWebviewJobHandler";
import { handleResearchWebviewMessage } from "./copilotWebviewResearchHandler";
import {
...
} from "./copilotWebviewTodoUploads";
import {
  getResolvedWorkspaceRootPaths,
  getGlobalPromptsPath,
} from "./copilotWebviewTemplateCache";
import {
...
} from "./copilotWebviewCommands";
import { createSchedulerWebviewCurrentRenderContext } from "./copilotWebviewRenderContext";
import { buildSchedulerTaskEditorMarkup } from "./copilotWebviewTaskEditorMarkup";
import { buildSchedulerWebviewChromeStyles } from "./copilotWebviewChromeStyles";
import { buildSchedulerWebviewSharedStyles } from "./copilotWebviewSharedStyles";
import { buildSchedulerWebviewExtendedStyles } from "./copilotWebviewExtendedStyles";
import {
  buildSchedulerListTabMarkup,
  buildSchedulerTodoEditorMarkup,
} from "./copilotWebviewTodoMarkup";
import { buildSchedulerWorkspaceTabsMarkup } from "./copilotWebviewWorkspaceTabsMarkup";
import {
  runSchedulerWebviewBackgroundRefresh,
  seedSchedulerWebviewCatalogFallbacks,
} from "./copilotWebviewShowSupport";
import { handleSchedulerWebviewCoreMessage } from "./copilotWebviewMessageRouting";
import {
...
} from "./copilotWebviewUpdateDispatch";
import {
  createFreshSchedulerPanel,
  replaySchedulerPanel,
} from "./copilotWebviewPanelLifecycle";
import {
...
export class SchedulerWebview {
  ...
  private static get currentScheduleHistory(): ScheduleHistoryEntry[] { return this.readRuntimeState("copilotHistory"); }
  private static set currentScheduleHistory(value: ScheduleHistoryEntry[]) { this.writeRuntimeState("copilotHistory", value); }
