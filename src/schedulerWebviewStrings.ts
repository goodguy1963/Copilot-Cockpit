...
export function buildSchedulerWebviewStrings(
  ...
  return {
    ...
    boardCommentQuickActions: localize("Comment quick actions", "コメントのクイック操作", "Kommentar-Schnellaktionen"),
    boardCommentQuickActionsHint: localize("Tap a starter to scaffold the note quickly.", "スターターを押すとメモの骨組みをすばやく作れます。", "Klicken Sie auf einen Starter, um die Notiz schnell zu strukturieren."),
    boardCommentTemplateContext: localize("Context", "コンテキスト", "Kontext"),
    boardCommentTemplateDecision: localize("Decision", "判断", "Entscheidung"),
    boardCommentTemplateApproval: localize("Approval", "承認", "Freigabe"),
    boardCommentTemplateContextBody: localize("Context:\n", "コンテキスト:\n", "Kontext:\n"),
    boardCommentTemplateDecisionBody: localize("Decision:\n", "判断:\n", "Entscheidung:\n"),
    boardCommentTemplateApprovalBody: localize("Approval / next step:\n", "承認 / 次のステップ:\n", "Freigabe / nächster Schritt:\n"),
