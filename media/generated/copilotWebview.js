...
(() => {
  ...
  // media/copilotWebviewCronUtils.js
  ...
  // media/copilotWebviewPromptState.js
  ...
  // media/copilotWebviewTaskCards.js
  ...
  // media/copilotWebviewTaskActions.js
  ...
  // media/copilotWebviewTaskSelectState.js
  ...
  // media/copilotWebviewDisplayUtils.js
  ...
  // media/copilotWebviewBootstrap.js
  ...
  // media/copilotWebviewInitialState.js
  ...
  // media/copilotWebviewDomRefs.js
  function createSchedulerWebviewDomRefs(document2) {
    return {
      ...
      copilotHistorySelect: document2.getElementById("schedule-history-select"),
  ...
  // media/copilotWebviewDefaults.js
  ...
  // media/copilotWebviewTabState.js
  ...
  // media/copilotWebviewBindings.js
  ...
  // media/copilotWebviewFormBindings.js
  ...
  // media/copilotWebviewTaskSubmit.js
  ...
  // media/copilotWebviewToolbarBindings.js
  ...
  function bindRestoreHistoryButton(button, options) {
    bindClickAction(button, function() {
      var snapshotId = options.copilotHistorySelect ? options.copilotHistorySelect.value : "";
      if (!snapshotId) {
        options.window.alert(
          options.strings.copilotHistoryRestoreSelectRequired || "Select a backup version first"
        );
        return;
      }
      ...
      var confirmText = (options.strings.copilotHistoryRestoreConfirm || "Restore the repo schedule from {createdAt}? The current state will be backed up first.").replace("{createdAt}", selectedLabel).replace("{timestamp}", selectedLabel);
  ...
  // media/copilotWebviewJobBindings.js
  ...
  // media/copilotWebviewUtilityBindings.js
  ...
  // media/copilotWebviewJobInteractions.js
  ...
  // media/copilotWebviewTransientState.js
  ...
  (function() {
    ...
    var copilotHistory = initialState.copilotHistory;
    ...
    function formatHistoryLabel(entry) {
      if (!entry || !entry.createdAt) {
        return strings.copilotHistoryPlaceholder || "Select a backup version";
      }
    ...
    function syncScheduleHistoryOptions() {
      if (!copilotHistorySelect) return;
      var previousValue = copilotHistorySelect.value || "";
      var entries = Array.isArray(copilotHistory) ? copilotHistory : [];
      entries = entries.slice().sort(function(a, b) {
        return new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime();
      });
      if (entries.length === 0) {
        copilotHistorySelect.innerHTML = '<option value="">' + escapeHtml(strings.copilotHistoryEmpty || "No backup versions yet") + "</option>";
        copilotHistorySelect.disabled = true;
        if (restoreHistoryBtn) restoreHistoryBtn.disabled = true;
        return;
      }
      copilotHistorySelect.innerHTML = '<option value="">' + escapeHtml(strings.copilotHistoryPlaceholder || "Select a backup version") + "</option>" + entries.map(function(entry) {
        return '<option value="' + escapeAttr(entry.id || "") + '">' + escapeHtml(formatHistoryLabel(entry)) + "</option>";
      }).join("");
      copilotHistorySelect.disabled = false;
      if (restoreHistoryBtn) restoreHistoryBtn.disabled = false;
      if (previousValue) {
        copilotHistorySelect.value = previousValue;
      }
      if (copilotHistorySelect.value !== previousValue) {
        copilotHistorySelect.value = "";
      }
    }
    ...
    function renderTaskList(nextTasks) {
      ...
      function renderReadyTodoDraftCandidateCard(todo) {
        ...
        return '<div class="task-card todo-draft-candidate" data-ready-todo-id="' + escapeAttr(todo.id || "") + '"><div class="task-card-top"><div class="task-header" role="banner"><div class="task-header-main"><div class="task-title-row"><span class="task-name">' + title + '</span></div><span class="task-status enabled">' + escapeHtml(strings.boardFlagPresetReady || "Ready") + '</span></div><div class="task-badges task-badges-inline"><span class="task-badge">Ready Todo</span></div></div><div class="task-meta-strip">' + renderTaskMetaPill(
      ...
      try {
        switch (messageType) {
          ...
          case "updateScheduleHistory":
            copilotHistory = Array.isArray(message.entries) ? message.entries : [];
