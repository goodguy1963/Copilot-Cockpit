...
} from "./copilotWebviewBoardInteractions.js";
import { createWebviewDebugTools } from "./copilotWebviewDebug.js";
import { renderTodoBoardMarkup } from "./copilotWebviewBoardRendering.js";
import {
  buildFriendlyCronExpression,
  summarizeCronExpression,
  syncFriendlyFieldVisibility,
} from "./copilotWebviewCronUtils.js";
import {
  applyPromptSourceUi,
  restorePendingSelectValue,
  syncPromptTemplatesFromMessage,
  updatePromptTemplateOptions,
} from "./copilotWebviewPromptState.js";
import {
  buildBaseTaskActionsMarkup,
  buildTaskConfigRowMarkup,
} from "./copilotWebviewTaskCards.js";
import { handleTaskListClick } from "./copilotWebviewTaskActions.js";
import {
  selectHasOptionValue,
  populateAgentDropdown as updateTaskAgentOptions,
  populateModelDropdown as updateTaskModelOptions,
} from "./copilotWebviewTaskSelectState.js";
import {
  formatCountdown,
  formatModelLabel,
...
} from "./copilotWebviewDisplayUtils.js";
import {
  installGlobalErrorHandlers,
  readInitialWebviewBootstrap,
} from "./copilotWebviewBootstrap.js";
import { createInitialSchedulerWebviewState } from "./copilotWebviewInitialState.js";
import { createSchedulerWebviewDomRefs } from "./copilotWebviewDomRefs.js";
import {
  createBoardRenderState,
  finishBoardDrag,
  requestBoardRender,
} from "./copilotWebviewBoardState.js";
import {
  createStorageSettingsNormalizer,
  resolveInitialSchedulerCollections,
} from "./copilotWebviewDefaults.js";
import {
...
} from "./copilotWebviewTabState.js";
import {
  bindClickAction,
  ...
  bindSelectChange,
} from "./copilotWebviewBindings.js";
import {
  bindCronPresetPair,
  bindPromptSourceDelegation,
  bindTemplateSelectionLoader,
} from "./copilotWebviewFormBindings.js";
import {
  buildTaskSubmissionData,
  postTaskSubmission,
  validateTaskSubmission,
} from "./copilotWebviewTaskSubmit.js";
import {
  bindAutoShowStartupButton,
  bindRefreshButton,
  bindRestoreHistoryButton,
  bindTaskTestButton,
} from "./copilotWebviewToolbarBindings.js";
import { bindJobToolbarButtons } from "./copilotWebviewJobBindings.js";
import {
  bindLanguageSelectors,
  bindTemplateRefreshButton,
  bindUtilityActionButtons,
} from "./copilotWebviewUtilityBindings.js";
import {
  bindJobDragAndDrop,
  bindJobNodeWindowChange,
  handleSchedulerDetailClick,
} from "./copilotWebviewJobInteractions.js";
import { createSchedulerWebviewTransientState } from "./copilotWebviewTransientState.js";
...
(function () {
  ...
  function syncScheduleHistoryOptions() {
    ...
    if (entries.length === 0) {
      copilotHistorySelect.innerHTML =
        '<option value="">' +
        escapeHtml(strings.copilotHistoryEmpty || "No backup versions yet") +
        "</option>";
    ...
    copilotHistorySelect.innerHTML =
      '<option value="">' +
      escapeHtml(strings.copilotHistoryPlaceholder || "Select a backup version") +
      "</option>" +
      entries
        .map(function (entry) {
          return (
...
syncTodoLabelSuggestions();
  ...
  bindRestoreHistoryButton(restoreHistoryBtn, {
    copilotHistorySelect: copilotHistorySelect,
    ...
    try {
      switch (messageType) {
        ...
        case "updateScheduleHistory":
          copilotHistory = Array.isArray(message.entries)
            ? message.entries
            : [];
