...
} from "./cockpitWebviewDisplayUtils.js";
import {
  installGlobalErrorHandlers,
  readInitialWebviewBootstrap,
} from "./cockpitWebviewBootstrap.js";
import { createInitialSchedulerWebviewState } from "./cockpitWebviewInitialState.js";
import { createSchedulerWebviewDomRefs } from "./cockpitWebviewDomRefs.js";
import {
  createBoardRenderState,
  finishBoardDrag,
  requestBoardRender,
} from "./cockpitWebviewBoardState.js";
import {
  createStorageSettingsNormalizer,
  resolveInitialSchedulerCollections,
} from "./cockpitWebviewDefaults.js";
import {
...
} from "./cockpitWebviewTabState.js";
import {
  bindClickAction,
  ...
  bindSelectChange,
} from "./cockpitWebviewBindings.js";
import {
  bindCronPresetPair,
  bindPromptSourceDelegation,
  bindTemplateSelectionLoader,
} from "./cockpitWebviewFormBindings.js";
import {
  buildTaskSubmissionData,
  postTaskSubmission,
  validateTaskSubmission,
} from "./cockpitWebviewTaskSubmit.js";
import {
  bindAutoShowStartupButton,
  bindRefreshButton,
  bindRestoreHistoryButton,
  bindTaskTestButton,
} from "./cockpitWebviewToolbarBindings.js";
import { bindJobToolbarButtons } from "./cockpitWebviewJobBindings.js";
import {
  bindLanguageSelectors,
  bindTemplateRefreshButton,
  bindUtilityActionButtons,
} from "./cockpitWebviewUtilityBindings.js";
import {
  bindJobDragAndDrop,
  bindJobNodeWindowChange,
  handleSchedulerDetailClick,
} from "./cockpitWebviewJobInteractions.js";
import { createSchedulerWebviewTransientState } from "./cockpitWebviewTransientState.js";
...
(function () {
  ...
  // Collapsed sections â€” persisted in localStorage
  ...
  function syncScheduleHistoryOptions() {
    ...
    if (entries.length === 0) {
      cockpitHistorySelect.innerHTML =
        '<option value="">' +
        escapeHtml(strings.cockpitHistoryEmpty || "No backup versions yet") +
        "</option>";
    ...
    cockpitHistorySelect.innerHTML =
      '<option value="">' +
      escapeHtml(strings.cockpitHistoryPlaceholder || "Select a backup version") +
      "</option>" +
      entries
        .map(function (entry) {
          return (
...
syncTodoLabelSuggestions();
  ...
  bindRestoreHistoryButton(restoreHistoryBtn, {
    cockpitHistorySelect: cockpitHistorySelect,
    cockpitHistory: cockpitHistory,
    strings: strings,
