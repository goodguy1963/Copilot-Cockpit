...
- `TEAM-RULES.md`: shared rules that apply across the starter pack.
- `CEO-WORKFLOW-GUIDE.md`: practical orchestration loop for non-trivial work.
- `AGENT-SYSTEM-MAINTENANCE.md`: how to evolve the roster and shared docs without drift.
- `knowledge/`: reusable reference notes for architecture, planning, Todo Cockpit, sessions, and knowledge-base hygiene.
...
- The `.agent.md` files in this folder are the starter pack's behavioral source of truth.
- The shared docs in this folder explain how the starter pack should be operated and maintained.
...
2. Update `TEAM-RULES.md`, `README.md`, or `knowledge/` when the change affects shared behavior.
3. Keep reusable process guidance in the shared docs instead of duplicating it across every agent.